...
/**
 * Level 1 of the game, mainly a tutorial & introduction
 * 
 * @author Michael Ma, Ricky Chen
 * @version 1
 */
public class Level1 extends Controller
{
    ...
    //this is the only change I made, move the displayText up here and change the words
    private DisplayText displayText = new DisplayText("Ugg... Where am I? I should find someone who knows what's going on.");
    ...
    public Level1()
    {    
        // Create a new world with 24x18 size of 40 pixel segments (960x640)1

        super(24, 16, 40); 
        level = 1;
        bgm = new GreenfootSound("inTheBeginning.mp3");//binding of isaac
        prepare();
    }
    ...
    private void prepare()
    {
        ...
        addObject(woodenwall, 1, 12);
        WoodenWall woodenwall2 = new WoodenWall();
        addObject(woodenwall2, 2, 12);
        WoodenWall woodenwall3 = new WoodenWall();
        addObject(woodenwall3, 3, 12);
        WoodenWall woodenwall4 = new WoodenWall();
        addObject(woodenwall4, 4, 12);
        WoodenWall woodenwall5 = new WoodenWall();
        addObject(woodenwall5, 4, 13);
        WoodenWall woodenwall6 = new WoodenWall();
        addObject(woodenwall6, 4, 14);
        BronzeKey bronzekey = new BronzeKey();
        addObject(bronzekey, 1, 13);
        removeObject(woodenwall3);
        WoodenDoor woodendoor = new WoodenDoor();
        addObject(woodendoor, 3, 12);
        removeObject(woodenwall5);
        WoodenDoor woodendoor2 = new WoodenDoor();
        addObject(woodendoor2, 4, 13);
        WoodenWall woodenwall7 = new WoodenWall();
        addObject(woodenwall7, 4, 11);
        WoodenWall woodenwall8 = new WoodenWall();
        addObject(woodenwall8, 5, 12);
        WoodenWall woodenwall9 = new WoodenWall();
        addObject(woodenwall9, 6, 12);
        WoodenWall woodenwall10 = new WoodenWall();
        addObject(woodenwall10, 7, 12);
        WoodenWall woodenwall11 = new WoodenWall();
        addObject(woodenwall11, 8, 12);
        WoodenWall woodenwall12 = new WoodenWall();
        addObject(woodenwall12, 9, 12);
        WoodenWall woodenwall13 = new WoodenWall();
        addObject(woodenwall13, 10, 12);
        WoodenWall woodenwall14 = new WoodenWall();
        addObject(woodenwall14, 11, 12);
        WoodenWall woodenwall15 = new WoodenWall();
        addObject(woodenwall15, 12, 12);
        WoodenWall woodenwall16 = new WoodenWall();
        addObject(woodenwall16, 13, 12);
        WoodenWall woodenwall17 = new WoodenWall();
        addObject(woodenwall17, 14, 12);
        WoodenWall woodenwall18 = new WoodenWall();
        addObject(woodenwall18, 15, 12);
        WoodenWall woodenwall19 = new WoodenWall();
        addObject(woodenwall19, 16, 12);
        WoodenWall woodenwall20 = new WoodenWall();
        addObject(woodenwall20, 17, 12);
        WoodenWall woodenwall21 = new WoodenWall();
        addObject(woodenwall21, 18, 12);
        WoodenWall woodenwall22 = new WoodenWall();
        addObject(woodenwall22, 19, 12);
        WoodenWall woodenwall23 = new WoodenWall();
        addObject(woodenwall23, 20, 12);
        WoodenWall woodenwall24 = new WoodenWall();
        addObject(woodenwall24, 21, 12);
        WoodenWall woodenwall25 = new WoodenWall();
        addObject(woodenwall25, 22, 12);
        WoodenWall woodenwall26 = new WoodenWall();
        addObject(woodenwall26, 4, 10);
        WoodenWall woodenwall27 = new WoodenWall();
        addObject(woodenwall27, 4, 9);
        WoodenWall woodenwall28 = new WoodenWall();
        addObject(woodenwall28, 4, 8);
        WoodenWall woodenwall29 = new WoodenWall();
        addObject(woodenwall29, 4, 7);
        WoodenWall woodenwall30 = new WoodenWall();
        addObject(woodenwall30, 4, 5);
        WoodenWall woodenwall31 = new WoodenWall();
        addObject(woodenwall31, 4, 6);
        WoodenWall woodenwall32 = new WoodenWall();
        addObject(woodenwall32, 4, 4);
        WoodenWall woodenwall33 = new WoodenWall();
        addObject(woodenwall33, 4, 3);
        WoodenWall woodenwall34 = new WoodenWall();
        addObject(woodenwall34, 5, 3);
        WoodenWall woodenwall35 = new WoodenWall();
        addObject(woodenwall35, 6, 3);
        WoodenWall woodenwall36 = new WoodenWall();
        addObject(woodenwall36, 7, 3);
        WoodenWall woodenwall37 = new WoodenWall();
        addObject(woodenwall37, 8, 3);
        WoodenWall woodenwall38 = new WoodenWall();
        addObject(woodenwall38, 9, 3);
        WoodenWall woodenwall39 = new WoodenWall();
        addObject(woodenwall39, 10, 3);
        WoodenWall woodenwall40 = new WoodenWall();
        addObject(woodenwall40, 11, 3);
        WoodenWall woodenwall41 = new WoodenWall();
        addObject(woodenwall41, 12, 3);
        WoodenWall woodenwall42 = new WoodenWall();
        addObject(woodenwall42, 13, 3);
        WoodenWall woodenwall43 = new WoodenWall();
        addObject(woodenwall43, 14, 3);
        WoodenWall woodenwall44 = new WoodenWall();
        addObject(woodenwall44, 15, 3);
        WoodenWall woodenwall45 = new WoodenWall();
        addObject(woodenwall45, 16, 3);
        WoodenWall woodenwall46 = new WoodenWall();
        addObject(woodenwall46, 17, 3);
        WoodenWall woodenwall47 = new WoodenWall();
        addObject(woodenwall47, 18, 3);
        WoodenWall woodenwall48 = new WoodenWall();
        addObject(woodenwall48, 19, 3);
        WoodenWall woodenwall49 = new WoodenWall();
        addObject(woodenwall49, 20, 3);
        WoodenWall woodenwall50 = new WoodenWall();
        addObject(woodenwall50, 20, 4);
        WoodenWall woodenwall51 = new WoodenWall();
        addObject(woodenwall51, 20, 5);
        WoodenWall woodenwall52 = new WoodenWall();
        addObject(woodenwall52, 20, 6);
        WoodenWall woodenwall53 = new WoodenWall();
        addObject(woodenwall53, 20, 7);
        WoodenWall woodenwall54 = new WoodenWall();
        addObject(woodenwall54, 20, 8);
        WoodenWall woodenwall55 = new WoodenWall();
        addObject(woodenwall55, 20, 9);
        WoodenWall woodenwall56 = new WoodenWall();
        addObject(woodenwall56, 20, 10);
        WoodenWall woodenwall57 = new WoodenWall();
        addObject(woodenwall57, 20, 11);
        BronzeKey bronzekey2 = new BronzeKey();
        addObject(bronzekey2, 21, 11);
        removeObject(woodenwall25);
        WoodenDoor woodendoor3 = new WoodenDoor();
        addObject(woodendoor3, 22, 12);
        BloodyWoodenFloor bloodywoodenfloor77 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor77, 19, 4);
        BloodyWoodenFloor bloodywoodenfloor78 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor78, 19, 5);
        BloodyWoodenFloor bloodywoodenfloor79 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor79, 19, 6);
        BloodyWoodenFloor bloodywoodenfloor80 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor80, 19, 7);
        BloodyWoodenFloor bloodywoodenfloor81 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor81, 19, 8);
        BloodyWoodenFloor bloodywoodenfloor82 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor82, 19, 9);
        BloodyWoodenFloor bloodywoodenfloor83 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor83, 19, 10);
        BloodyWoodenFloor bloodywoodenfloor84 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor84, 19, 11);
        BloodyWoodenFloor bloodywoodenfloor85 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor85, 18, 11);
        BloodyWoodenFloor bloodywoodenfloor86 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor86, 17, 11);
        BloodyWoodenFloor bloodywoodenfloor87 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor87, 16, 11);
        BloodyWoodenFloor bloodywoodenfloor88 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor88, 15, 11);
        BloodyWoodenFloor bloodywoodenfloor89 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor89, 14, 11);
        BloodyWoodenFloor bloodywoodenfloor90 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor90, 13, 11);
        BloodyWoodenFloor bloodywoodenfloor91 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor91, 12, 11);
        BloodyWoodenFloor bloodywoodenfloor92 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor92, 11, 11);
        BloodyWoodenFloor bloodywoodenfloor93 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor93, 10, 11);
        BloodyWoodenFloor bloodywoodenfloor94 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor94, 9, 11);
        BloodyWoodenFloor bloodywoodenfloor95 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor95, 8, 11);
        BloodyWoodenFloor bloodywoodenfloor96 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor96, 7, 11);
        BloodyWoodenFloor bloodywoodenfloor97 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor97, 6, 11);
        BloodyWoodenFloor bloodywoodenfloor98 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor98, 5, 11);
        BloodyWoodenFloor bloodywoodenfloor99 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor99, 5, 10);
        BloodyWoodenFloor bloodywoodenfloor100 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor100, 5, 9);
        BloodyWoodenFloor bloodywoodenfloor101 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor101, 5, 8);
        BloodyWoodenFloor bloodywoodenfloor102 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor102, 5, 7);
        BloodyWoodenFloor bloodywoodenfloor103 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor103, 5, 6);
        BloodyWoodenFloor bloodywoodenfloor104 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor104, 5, 5);
        BloodyWoodenFloor bloodywoodenfloor105 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor105, 5, 4);
        BloodyWoodenFloor bloodywoodenfloor106 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor106, 6, 4);
        BloodyWoodenFloor bloodywoodenfloor107 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor107, 7, 4);
        BloodyWoodenFloor bloodywoodenfloor108 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor108, 8, 4);
        BloodyWoodenFloor bloodywoodenfloor109 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor109, 9, 4);
        BloodyWoodenFloor bloodywoodenfloor110 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor110, 10, 4);
        BloodyWoodenFloor bloodywoodenfloor111 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor111, 11, 4);
        BloodyWoodenFloor bloodywoodenfloor112 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor112, 12, 4);
        BloodyWoodenFloor bloodywoodenfloor113 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor113, 13, 4);
        BloodyWoodenFloor bloodywoodenfloor114 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor114, 14, 4);
        BloodyWoodenFloor bloodywoodenfloor115 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor115, 15, 4);
        BloodyWoodenFloor bloodywoodenfloor116 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor116, 16, 4);
        BloodyWoodenFloor bloodywoodenfloor117 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor117, 17, 4);
        BloodyWoodenFloor bloodywoodenfloor118 = new BloodyWoodenFloor();
        addObject(bloodywoodenfloor118, 18, 4);
        player = new Player() ; 
        ...
        Pakekel kelvin = new Pakekel(level);
        addObject(kelvin,8,8);
        DisplayText info = new DisplayText("Arrow keys to change direction\nSpace bar to move/interact");
        addObject(info,13,8);
