 ...
 * @version 1
 */
public class Level4 extends Controller
{
    ...
    public Level4 (Player player,InvisiblePlayer invisPlayer,Arrow arrow, EnemiesIcon enemyIcon)
    {
        super(24,16,40);
        level = 4;
        bgm = new GreenfootSound("Level4.mp3");
        prepare();
